...
func TestGetContainerApps(t *testing.T) {
...
func TestGetContainerApp(t *testing.T) {
...
func TestPatchContainerApp(t *testing.T) {
	cappRequest := types.Capp{
		Metadata: types.Metadata{
			Name:      "test-capp",
			Namespace: "test-namespace",
...
func TestDeleteContainerApp(t *testing.T) {
