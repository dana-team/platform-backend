module github.com/dana-team/platform-backend

go 1.22.2

require (
	github.com/crossplane/crossplane-runtime v1.16.0
	github.com/dana-team/container-app-operator v0.3.0
	github.com/dana-team/provider-dns v0.1.2
	github.com/dana-team/rcs-ocm-deployer v0.3.2
...
require (
	...
	github.com/cisco-open/operator-tools v0.36.0 // indirect
